...
class About extends Component {
    render() {
        return (
            <div className="content overflow-hidden" id="about">
              <Fade cascade top>
                <div className="p-20 border-0" id="about-card">
                    ...
                    <p className="text-justify text-muted">
                      ...
                      generous mix of at least four languages, I can confidently say that I am very much at ease in English, Hindi, Gujarathi, and Malayalam.
                ...
                <div className="p-20   border-0" id="about-card">
                    ...
                    <p className="text-justify text-muted">
                      ...
                      regularly, like any Indian, cricket still remains a personal favourite—ready to be rattled about at any time of the day. Apart from all of this, I am an eager learner, ready to delve into and 
                      take care of the most minute of things—absolutely love paying attention to the smallest of details. So if you have anything to 
                      talk about cricket, ramble on about the army or even the latest Dan Brown book, you know where to find me.
                    </p>
                </div>
                </Fade>
            </div>
