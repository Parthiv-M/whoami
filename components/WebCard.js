    ...
    return (
        <div className="flex flex-col web-card hover:-translate-y-2">
          ...
          <div className="bg-gray-900 w-full flex flex-col items-center rounded-xl -my-8 py-4 z-20">
            <h5 className="spline text-white md:text-2xl text-xl">{props.name}</h5>
            <a href={props.link} target="_blank" className="spline text-cyan-500 hover:underline text-sm">{props.link}</a>
